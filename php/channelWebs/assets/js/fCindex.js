window.addEventListener("load", function(e) {
    document.addEventListener("deviceready", function(e) {
        ...
        function gotoNCDRFlood(sel) {
            window.location.href = 'NCDRFlood.php?mid=' + sel.currentTarget.memberId + '&did=' + sel.currentTarget.value;
        }
        ...
        function gotoEOC(sel) {
            $.ajax({
                ...
                window.location.href = 'EOC.php?mid=' + sel.target.memberId + '&did=' + sel.target.value;
            }).fail(function(jqXhr, text, et) {});
        }

        function gotoNCDRSubList(sel) {
            window.location.href = 'NCDRSubLists.php?mid=' + sel.currentTarget.memberId + '&did=' + sel.currentTarget.value;
        }
